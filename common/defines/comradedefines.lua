...
NDefines.NGame.LAG_DAYS_FOR_LOWER_SPEED = 6000				-- Days of client lag for decrease of gamespeed
NDefines.NGame.LAG_DAYS_FOR_PAUSE = 6000				-- Days of client lag for pause of gamespeed.
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.25, 0.15, 0.045, 0.020 } -- game speeds for each level. Must be 5 entries with last one 0 for unbound
...
NDefines.NProduction.BASE_FACTORY_SPEED_NAV = 7.5 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
